package io.propcrm.crmapi.resource;

import io.propcrm.crmapi.domain.Contact;
import io.propcrm.crmapi.service.ContactService;
...
public class ContactResource {
 private final ContactService contactService;
    ...
    @DeleteMapping("/{id}")
    //add insert method so deleted contacts are backed up to seperate database
    public ResponseEntity<String> deleteContact(@PathVariable("id") String id) {
        Optional<Boolean> deleted = contactService.deleteContact(id);
